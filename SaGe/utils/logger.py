...
def get_root_logger(log_file=None, log_level=logging.INFO, use_mox=False):
    """Get the root logger.
    ...
    """
    #print('get_root_logger:', log_file)
    ...
    if rank != 0:
        ...
        #print('get_root_logger: log_file is not None')
        if use_mox:
            import moxing as mox
            mox.file.shift('os', 'mox')
