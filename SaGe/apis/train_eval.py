...
from .gssl_eval import GSSL_Eval

from openselfsup.datasets import build_dataloader
from openselfsup.hooks import build_hook, DistOptimizerHook, DistOptimizerDecoderHook, TextLoggerHook, CheckpointHook, \
    DecoderLrUpdaterHook, CosineAnnealingLrUpdaterHook
...
def _dist_train(model, dataset, cfg, logger=None, timestamp=None, meta=None):
    ...
    # register hooks
    runner.register_training_hooks(cfg.lr_config, optimizer_config, checkpoint_config, log_config)
